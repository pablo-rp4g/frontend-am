...
export default function Index() {
    ...
    //         validado:validado
    //     }
    //     const respuesta=await Axios.put('http://localhost:4000/cliente/actualizaValida/'+id,cliente,{
    //         headers: { 'autorizacion': token }
    //     })
    //     const mensaje=respuesta.data.mensaje
    //     Swal.fire({
                                    ...
                                    <tbody>
                                        {
                                            clientes.map((cliente, i) => (
                                                <tr key={cliente._id}>
                                                    ...
                                                    {/* <td>
                                                        <button className="btn btn-warning mr-1" onClick={() => actualizaValida(cliente._id)}>Validar</button>
